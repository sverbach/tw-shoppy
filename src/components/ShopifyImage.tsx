...
const srcSetValues = [50, 100, 200, 450, 600, 750, 900, 1000, 1250, 1500, 1750, 2000, 2500];

export default function ShopifyImage({ image, classList, loading = 'eager', sizes }: Props) {
  ...
  if (image) {
    ...
    return (
      <svg className="bg-slate-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 525.5 525.5">
